define(['exports', 'dojo/_base/declare', 'esri/geometry/Point', 'esri/layers/layer'], function (exports, _declare, _Point, _layer) {
  'use strict';
  ...
  exports.default = (0, _declare2.default)('EsriTileCanvasBase', [_layer2.default], {
    ...
    */
    _onZoomStart: function _onZoomStart() {
      ...
      Object.keys(this.tiles).forEach(function (key) {
        _this2.tiles[key].canvas.remove();
    ...
    */
    _drawTile: function _drawTile(data) {
      ...
      var latitude = latitudeFromTile(data.y, data.z);
      var coords = this._map.toScreen(new _Point2.default(longitude, latitude));
    ...
    */
    refresh: function refresh() {
      ...
      Object.keys(this.tiles).forEach(function (key) {
        ...
        var tileSize = _this4.options.tileSize;
        ...
        var imageData = ctx.getImageData(0, 0, tileSize, tileSize);
        imageData.data.set(_this4.filter(imageData.data));
        ctx.putImageData(imageData, 0, 0);
      });
    },
