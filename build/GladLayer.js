define(['exports', './EsriTileCanvasBase', 'dojo/_base/declare'], function (exports, _EsriTileCanvasBase, _declare) {
  ...
  exports.default = (0, _declare2.default)('GladLayer', [_EsriTileCanvasBase2.default], {
    ...
    filter: function filter(data) {
      for (var i = 0; i < data.length; i += 4) {
        ...
        if (values.date >= this.options.minDateValue && values.date <= this.options.maxDateValue && this.options.confidence.indexOf(values.confidence) > -1) {
    ...
    decodeDate: function decodeDate(pixel) {
